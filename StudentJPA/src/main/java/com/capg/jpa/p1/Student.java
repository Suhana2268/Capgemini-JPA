...
public class Student {
		...
		@JoinColumn(name = "Dept_name", referencedColumnName = "deptName")
		...
		public Student(int stuId, String studentName, int marks, int age, List<Courses> courseList,
				Certificates certificate, Department dept) {
			super();
			this.stuId = stuId;
		...
		public String toString() {
			return "Student [stuId=" + stuId + ", StudentName=" + StudentName + ", marks=" + marks + ", age=" + age
					+ ", courseList=" + courseList + ", certificate=" + certificate + ", dept=" + dept + "]";
		}
